...
#wait
git clone https://github.com/nguyenduongnhj/tasks.git $FOLDER_APPS_PATH/tasks
...
#wait
git clone https://github.com/nguyenduongnhj/spreed.git $FOLDER_APPS_PATH/spreed
cd $FOLDER_APPS_PATH/spreed
make dev-setup
make build-js

#wait
git clone https://github.com/nguyenduongnhj/calendar.git $FOLDER_APPS_PATH/calendar
cd $FOLDER_APPS_PATH/calendar
make dev-setup
make build-js

#wait
git clone https://github.com/nguyenduongnhj/deck.git $FOLDER_APPS_PATH/deck
cd $FOLDER_APPS_PATH/deck
make install-deps
make build

#wait
git clone https://github.com/nguyenduongnhj/richdocuments.git $FOLDER_APPS_PATH/richdocuments
